#ifndef VDR_CLIENT_H_
#define VDR_CLIENT_H_
...
class VdrClient:public QWidget
{
    Q_OBJECT

public:
    explicit VdrClient(QWidget *parent = 0);
    ~VdrClient();
    QWidget* GetWidget() const;
    QHBoxLayout* GetLayout() const;
private slots:

    void OnVdrVehiclePose(VehicleDeadReckoning vdr);
    void OnVdrVehicleParam(VehicleModelParam vpm);
...
private:
    ...
    QLineEdit* lineEdit_VehicleModelParam;
    ...
    QLabel* label_VehicleModelParam;
